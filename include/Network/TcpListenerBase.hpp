...
#ifndef QUE_NETWORK_TCP_LISTENER_BASE_HPP
#define QUE_NETWORK_TCP_LISTENER_BASE_HPP
...
namespace Que
{
	...
	///
	////////////////////////////////////////////////////////////////
	class TcpListenerBase : protected Socket
	{
	...
	public:
		...
		///
		////////////////////////////////////////////////////////////////
		virtual void Start(const unsigned short p_Port, const Address & p_ListenAddress = Address(0)) = 0;
		...
		///
		////////////////////////////////////////////////////////////////
		virtual bool Listen(TcpSocket & p_Connection, const Time & p_Timeout) = 0;
